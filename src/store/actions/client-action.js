import { addClient, loginClient, updateClient } from "./action-type";
...
export const getUsers = (id) => dispatch => {
    fetch(WEBSITE_URL + '/api/clientusers/me', {
        method: "POST",
        headers: {
        ...
        then(res2 => {
            ...
            return dispatch({ type: addClient, payload: res2 });
        }
        );
};
...
export const addUser = (data) => dispatch => {
    ...
    fetch(WEBSITE_URL + '/api/clientusers', {
        method: "post",
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
    ...
    fetch(WEBSITE_URL + '/api/auth', {
        ...
        then(res2 => {
            if (res2.success == 1) {
                ...
                return dispatch({ type: loginClient, payload: res2 });
            }
            else
                return ToastAndroid.show(res2.message, ToastAndroid.LONG);
        }
...
export const UpdateUser = (data, id) => dispatch => {
    console.log("Data is: ", data);
    fetch(WEBSITE_URL + '/api/clientusers/'+ id, {
        method: "PUT",
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
        ...
        then(res2 => {
            if (res2.success == 1) {
                ...
                ToastAndroid.show(res2.message, ToastAndroid.LONG);
                return dispatch({ type: updateClient, payload: res2 });
            }
            else
                return ToastAndroid.show(res2.message, ToastAndroid.LONG);
        }
