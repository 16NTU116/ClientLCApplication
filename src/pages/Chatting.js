...
import lego from '../image/lego.png';
...
//     const room = 'vendor';
//     this.props.loadMessages({ name: user.name })
//       // .then(() => {
...
//             <FlatList
//               key={this.props.chat.messages.msg}
//               ref={ref => (this.flatList = ref)}
//               onContentSizeChange={() =>
//                 this.flatList.scrollToEnd({ animated: true })
//               }
...
//               keyExtractor={item => item.msgid}
//             />
//           ) : console.log("Data at Chatting Module", this.props.chat.messages)}
//         </Content>
//         <Footer style={styles.footer}>
//           <Input
//             style={styles.Input}
...
// export default connect(mapStateToProps, { sendMessage, loadMessages })(Chatroom);
