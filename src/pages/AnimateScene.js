...
import { getUsers } from "../store/actions/client-action";
...
class AnimateScene extends Component {
  ...
  componentDidMount() {
    ...
    const { navigation, getUsers, getPosts, getAssignedPosts, user } = this.props;
    const that = this;
    Animated.parallel([
...
export default connect(mapStateToProps, { getUsers, getPosts, getAssignedPosts })(AnimateScene);
